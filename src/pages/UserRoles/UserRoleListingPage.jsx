...
import AddUserRolesModal from "../../features/UserRoles/AddUserRolesModal";
import UserRolesTable from "../../features/UserRoles/UserRolesTable";
import usePermission from "../../hooks/usePermission";

function UserRoleListingPage() {
    ...
    const fetchroleList = async () => {
        try {
            ...
            setRoleList(response?.data?.adminRoles);
            setFilters((prev) => {
                return {
                    ...prev,
                    totalroleList: response?.data?.totalAdminRoles,
                };
            });
            setIsLoading(false);
        } catch (err) {
...
export default UserRoleListingPage;
